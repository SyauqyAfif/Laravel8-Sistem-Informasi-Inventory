            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="/brg_klr/store">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly="" value="{{ 'KBK-'.$kd  }}" name="no_brg_klr" placeholder="No Barang Keluar ... " required>
                                </div>

                                <div class="form-group">
                                    <label>Tanggal Barang Keluar</label>
                                    <input type="date" class="form-control" name="tgl_brg_klr">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" placeholder="Jumlah barang ..." id="jml_brg_klr" name="jml_brg_klr" required>
                            ...
                            <div class="card-action">
                                ...
                                <a href="/brg_klr" class="btn btn-danger"> <i class="fa fa-undo"></i> Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#jml_brg_klr").keyup(function() {
            ...
            var total = parseInt(harga_jual) * parseInt(jml_brg_klr);
            $("#total").val(total);
        });
    });
</script>
